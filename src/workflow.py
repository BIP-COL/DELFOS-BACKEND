        ...
        async with MCPStreamableHTTPTool(
            ...
            async with AzureAIAgentClient(
                ...
                async with AzureAIAgentClient(
                    ...
                    # Find messages from each agent by author_name (optimized single pass)
                    raw_intent = ""
                    raw_sql_result = ""
                    text_messages = []
            ...
            if intent == "requiere_visualizacion" and response.sql_data:
                ...
                async with AzureAIAgentClient(
                    ...
                    viz_input = json.dumps(viz_input_data, separators=(',', ':'), ensure_ascii=False)
            ...
            if response.viz_data and response.viz_data.run_id and response.viz_data.tipo_grafico:
                ...
                graph_input = json.dumps(graph_input_data, separators=(',', ':'), ensure_ascii=False)
            ...
            if response.success and response.sql_data:
                ...
                format_input = json.dumps(format_input_data, separators=(',', ':'), ensure_ascii=False)
